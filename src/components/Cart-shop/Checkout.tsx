...
const Checkout: React.FC = (props:any) => {
  ...
  const confirmHandler = (event: any) => {
    ...
    const enteredStreet: any = streetInputRef.current!.value;
    const enteredPostalCode: any = postalCodeInputRef.current!.value;
    const enteredCity: any = cityInputRef.current!.value;
